...
# StructureDataset glottolog/glottolog: Glottolog database 5.0 as CLDF
...
property | value
 --- | ---
[dc:bibliographicCitation](http://purl.org/dc/terms/bibliographicCitation) | Hammarström, Harald & Forkel, Robert & Haspelmath, Martin & Bank, Sebastian. 2024. Glottolog 5.0. Leipzig: Max Planck Institute for Evolutionary Anthropology. (Available online at https://glottolog.org)
...
[prov:wasDerivedFrom](http://www.w3.org/ns/prov#wasDerivedFrom) | <ol><li><a href="https://github.com/glottolog/glottolog-cldf/tree/v4.8">glottolog/glottolog-cldf v4.8</a></li><li><a href="https://github.com/glottolog/glottolog/tree/v5.0">Glottolog v5.0</a></li></ol>
[prov:wasGeneratedBy](http://www.w3.org/ns/prov#wasGeneratedBy) | <ol><li><a href="https://github.com/glottolog/pyglottolog/tree/3.13.0">glottolog/pyglottolog 3.13.0</a></li><li><strong>python</strong>: 3.10.12</li><li><strong>python-packages</strong>: <a href="./requirements.txt">requirements.txt</a></li></ol>
...
[dc:extent](http://purl.org/dc/terms/extent) | 134185
...
`type` | `string`<br>Valid choices:<br> `categorical` `sequential` `other` | Describes the domain of the parameter
...
[dc:extent](http://purl.org/dc/terms/extent) | 26879
...
`Level` | `string`<br>Valid choices:<br> `language` `dialect` `family` | Glottolog languoid level.
...
[Language_ID](http://cldf.clld.org/v1.0/terms.rdf#parentLanguageGlottocode) | `string` | Glottocode of the language-level languoid, the languoid belongs to (in case of dialects)<br>References [languages.csv::ID](#table-languagescsv)
...
property | value
 --- | ---
[dc:extent](http://purl.org/dc/terms/extent) | 120067
...
[dc:extent](http://purl.org/dc/terms/extent) | 246
